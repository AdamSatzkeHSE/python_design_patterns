...
class CreatureModifier(ABC):
    ...
    # Set the context manager enter and exit magic methods
    def __enter__(self):
        return self
...
if __name__ == '__main__':
    ...
    # Difference to method - chain: As soon as it is called it is applied
    with DoubleAttackModifier(game, goblin):
        print(goblin)
        with IncreaseDefenseModifier(game, goblin):
            print(goblin)
    # As soon as we exit the scope we unsubscribe.
    print(goblin)
